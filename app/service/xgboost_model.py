...
from app.common.data_loader import load_data_from_csv
from app.service.pymc_adjust import custom_objective_factory
...
def train_normal_xgboost(
    ...
    if method == "split":
        ...
        model.save_model(os.path.join(output_dir, "model_normal.xgb"))
        ...
        booster.save_model(os.path.join(output_dir, "model_normal.xgb"))
...
def train_custom_xgboost(
    ...
    if method == "split":
        ...
        model.save_model(os.path.join(output_dir, "model_custom.xgb"))
        return model, evals_result
        ...
        booster.save_model(os.path.join(output_dir, "model_custom.xgb"))
