...
from app.common.common_methods import *
...
def test_models_plots():
    ...
    normal_model_path = os.path.join("app", "output", "model_normal.xgb")
    custom_model_path = os.path.join("app", "output", "model_custom.xgb")

    # Fallback to old paths if models don't exist in output directory
    if not os.path.isfile(normal_model_path):
